...
describe('Order Confirmation actions', () => {
  ...
  describe('Get all orderConfirmations', () => {
    it('Should return 200 Success when an admin successfully retrieves all orderConfirmations.', async () => {
    ...
    it('Should return 200 Success when a user successfully retrieves all orderConfirmations.', async () => {
  ...
  describe('Get oderConfirmation by id', () => {
    ...
    it('Should return 200 Success when an admin successfully retrieves an orderConfirmation by ID', async () => {
      const res = await chai
        .request(app)
    ...
    it('Should return 200 Success when a company admin successfully retrieves an orderConfirmation by id for their company', async () => {
      const res = await chai
        .request(app)
    ...
    it('Should return 200 Success when a user successfully retrieves their own orderConfirmation by id', async () => {
      const res = await chai
        .request(app)
    ...
    it('Should return 403 Forbidden when a user tries to access an orderConfirmation that does not belong to them', async () => {
      ...
      expect(res.body.errors.message).to.equal('You are not authorized to access this orderConfirmation')
    })
  })
})
